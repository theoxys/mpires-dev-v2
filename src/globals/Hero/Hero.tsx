  ...
  return (
    <Link
      ...
      className={cn(
        ...
        'hover:shadow-primary/20 hover:before:-translate-x-40',
        ...
        'before:bg-neutral-inverse/70 before:opacity-5',
        'before:duration-700',
        'hover:scale-105',
        className,
      )}
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        'border border-element bg-element',
        'hover:shadow-neutral/20 hover:before:-translate-x-40',
        'shadow-transparent shadow-2xl',
        'text-neutral',
        'transition-all',
        'before:ease before:absolute before:right-0 before:top-0',
